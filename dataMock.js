...
const companyData = {
  ...
  remark:
    'หมายเหตุ หรือ เชิงอรรถ คือข้อความที่วางอยู่ที่ตำแหน่งล่างสุดของหน้าในหนังสือหรือเอกสาร หรือที่ตำแหน่งจบบท จบเล่ม หรือข้อความทั้งหมด เนื้อหาของหมายเหตุสามารถใส่ความเห็นของผู้แต่งจากข้อความหลัก หรือการอ้างอิงงานเขียนที่สนับสนุนข้อความ หรือทั้งสองอย่าง การระบุหมายเหตุตามปกติกระทำโดยกำกับตัวเลขแบบนั้น',
  productValueBeforeFormDiscount: 0,
  selectedTableType: 0, //NOTE: 0 -> แยกรายการ / 1 -> รวมท้ายบิล
  selectedCalType: 1,
  issuedDate: '2024-06-04',
  dueDate: '2024-06-04',
  approvedDate: '2024-06-04', // Putter's mock
  sumIncludeTax: null,
  withholdingTaxAmount: 3.75,
  vatPrice: 35,
  paymentCondition:
    'หมายเหตุ หรือ เชิงอรรถ คือข้อความที่วางอยู่ที่ตำแหน่งล่างสุดของหน้าในหนังสือหรือเอกสาร หรือที่ตำแหน่งจบบท จบเล่ม หรือข้อความทั้งหมด เนื้อหาของหมายเหตุ หมายเหตุ หรือ เชิงอรรถ',
  deposit: 0,
  taxIdent: 'QT0000020240701-00001',
  expiredDate: '2024-06-04',
  companyAddress:
    'อาคารแชปเตอร์วัน โมเดิร์นดัชต์ คอนโดมิเนียม อาคารบี ชั้น1 เลขที่69/1866 ซอยราษฎร์บูรณะ33 ถนนราษฎร์บูรณะ แขวงราษฎร์บูรณะ เขตราษฎร์บูรณะ กรุงเทพมหานคร 10140',
  ...
  documentItems: [
    {
      ...
      productDescription: 'ชาเขียวแท้ 100% บรรจุขวด ชาเขียวแท้ ',
      unitId: '2e063f6e-97a1-4be7-95a0-001e710c1dd6',
      unitName: 'ลัง',
      unitPrice: 5000000,
      discount: 50,
      quantity: 1,
      totalPriceBeforeTax: 5000000,
      selected_paytax: 0.02,
      selected_vat: 0,
      productCode: 'PO00001111111',
    ...
    },
    {
      selectedProductId: 'd119ff66-2fee-4474-8397-911ac5d90de1',
      productName: 'ชาเขียวแท้ บรรจุขวด 100%',
      productDescription: 'Toro Toro โทโร โทโร่ ขนมครีมแมวเลีย สูตรปลาทูน่า',
      unitId: '2e063f6e-97a1-4be7-95a0-001e710c1dd6',
      unitName: 'ลัง',
      unitPrice: 500,
      discount: 0,
    ...
    },
    {
      selectedProductId: 'd119ff66-2fee-4474-8397-911ac5d90de1',
      productName: 'ชาเขียวแท้ บรรจุขวด 100%',
      productDescription: 'Me-O มีโอ ครีมมี่ทรีตขนมแมวเลีย รสไก่และตับ',
      unitId: '2e063f6e-97a1-4be7-95a0-001e710c1dd6',
      unitName: 'ลัง',
      unitPrice: 500,
      discount: 0,
    ...
    },
    {
      selectedProductId: 'd119ff66-2fee-4474-8397-911ac5d90de1',
      productName: 'ชาเขียวแท้ บรรจุขวด 100%',
      productDescription: 'ชาเขียวแท้ 100% บรรจุขวดชาเขียวแท้ 100%',
      unitId: '2e063f6e-97a1-4be7-95a0-001e710c1dd6',
      unitName: 'ลัง',
      unitPrice: 500,
      discount: 0,
  ...
  state: 0,
  yearType: 0, //NOTE: 1->ค.ศ. / 0->พ.ศ.
  // NOTE: ข้อมูลข้างใต้ พัตเตอร์สร้างขึ้นมาเอง
  companyLogo:
    'https://s3.ap-southeast-1.amazonaws.com/new-accistant.accrevos.com/tenant/3454353453434/logoCompany/1720596593810-1720596591138?AWSAccessKeyId=AKIATDTLGGMUQQUEEWZI&Expires=1752132594&Signature=priyAzp7EPFqr02Ze4QCgrn8X7U%3D',
  userSignature:
